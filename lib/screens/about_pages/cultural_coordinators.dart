...
class CulturalCentralCoordinators extends StatelessWidget {
  const CulturalCentralCoordinators({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    var widgetList = <Widget>[];
    for (var data in centralCoordinatorsCultural) {
